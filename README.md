...
欢迎提交新的 awesome-ipfs 项目。 为了向这个列表添加一个元素，您需要修改`/data` 运行一个简单的 `make build` 在发布您的 pull 请求之前，因为 Readme 和站点都是自动生成的， 参考相关的[CONTRIBUTING.md guidelines](https://github.com/ipfs/awesome-ipfs/blob/master/CONTRIBUTING.md)指导方针

**注意**: 如果您想直接编辑 README 文件(而不是项目 / 链接) ，您需要修改 [README template](https://github.com/ipfs/awesome-ipfs/blob/master/scripts/readme-template.md)模板，然后运行 `make build` 

## 应用

- [3Box](https://3box.io) - 建立及管理你的个人档案及个人资料。 使用3box-js 库将配置文件集成到 dapp 中 [来源](https://github.com/uport-project/3box)
...
- 2018-08-06: [Ipfs 中的内容标识符](https://pascalprecht.github.io/posts/content-identifiers-in-ipfs/) 
- 2018-07-11: [关于防伪密码术的探讨](https://pascalprecht.github.io/posts/future-proofed-hashes-with-multihash/) 
- 2017-08-21: [理解 IPFS 白皮书第2部分](https://decentralized.blog/understanding-the-ipfs-white-paper-part-2.html) 
- 2017-08-10: [理解 IPFS 白皮书第1部分](https://decentralized.blog/understanding-the-ipfs-white-paper-part-1.html) 
- 2017-06-13: [分散式和分布式边缘计算来自Computes.io](https://blog.computes.io/decentralized-distributed-edge-computing-comes-to-computes-io-396aa062bc85) 
- 2017-05-05: [公共基因组数据的分散索引](https://github.com/luizirber/2017-recomb) 
- 2017-03-31: [利用 IPFS 进行物联网通信](https://medium.com/@chrismatthieu/using-ipfs-for-iot-communications-b49c2139783a) 
- 2016-09-12: [IPFS: 互联网民主化](https://medium.com/@tonywillenberg/web-3-0-a-truly-democratised-internet-f4b06cb4077b) 
- 2016-05-20: [更新播客](https://changelog.com/204/) 
- 2015-11-01: [Eris + IPFS](https://monax.io/blog/2015/11/01/eris-and-ipfs/) 
- 2015-09-18: [星际文件系统想要创建一个永久的网络](http://motherboard.vice.com/read/the-interplanetary-file-system-wants-to-create-a-permanent-web) 
- 2015-09-13: [介绍IPFS](http://whatdoesthequantsay.com/2015/09/13/ipfs-introduction-by-example) 
- 2015-09-10: [利用 IPFS 实现分布式永久 Web 的第一步](https://hacked.com/first-steps-toward-implementing-distributed-permanent-web-ipfs/) 
- 2015-09-08: [web 已经过时了。 现在是分布式永久网络的时候了](https://ipfs.io/ipfs/QmNhFJjGcMPqpuYfxL62VVB9528NXqDNMFXiqN5bgFYiZ1/its-time-for-the-permanent-web.html) 
- [通过 IPFS 下载具有 nvm / n 的 nodejs 版本](https://ipfs.io/ipfs/QmTkzDwWqPbnAh5YiV5VwcTLnGdwSNsNTn2aDxdXBFca7D/example#/ipfs/QmUx363UFtgiQqkHHsPK3TSDmwoALDo2hrbMWbcxjH2vFc) 
